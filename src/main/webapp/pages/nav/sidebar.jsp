<nav
  ...
  <div id="btnRawMaterialList"
    class="inline-flex hover:bg-[#965c5b] rounded py-2 hover:text-white">
    <div class="w-[40px] align-middle">
  ...
  <div id="btnFinishedProductList" class="inline-flex hover:bg-[#b0b980] rounded py-2 hover:text-white">
    <div class="w-[40px] align-middle">
      <i class="fas fa-calendar-day p-2"></i>
    </div>
  ...
  <div class="my-2">
    ...
    <ul id="dropdownMenuReport" class="bg-base-100 rounded-box z-[1] w-68 p-2 hidden">
      <li><a id="btnReportFinished" class="hover:bg-[#f95757] hover:text-white">Finished
          Inventory</a></li>
      <li><a id="btnReportPlanned" class="hover:bg-[#f95757] hover:text-white">Planned Raw
          Materials Inventory</a></li>
      <li><a id="btnReportProduction" class="hover:bg-[#f95757] hover:text-white">Production
          Report</a></li>
      <li><a id="btnReportReceived" class="hover:bg-[#f95757] hover:text-white">Received
  ...
  <div class="my-2">
    ...
    <ul id="dropdownMenuMaintenance" class="bg-base-100 rounded-box z-[1] w-68 p-2 hidden">
      <li><a id="btnDispatch"
        class="hover:bg-[#7db7ce] hover:text-white">Dispatch Types</a></li>
      <li><a id="btnBranches"
        class="hover:bg-[#7db7ce] hover:text-white">Branches</a></li>
      <li><a id="btnSkuCodes"
        class="hover:bg-[#7db7ce] hover:text-white">SKU Codes</a></li>
      <li><a id="btnMaterialCodes"
        class="hover:bg-[#7db7ce] hover:text-white">Material Codes</a></li>
      <li><a id="btnUserMaintenance"
        class="hover:bg-[#7db7ce] hover:text-white">User Maintenance</a></li>
    </ul>
  </div>
</nav>
