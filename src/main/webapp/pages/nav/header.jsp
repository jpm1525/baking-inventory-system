<header>
  <div class="flex topbar bg-white dark:bg-[#1f2937] text-[#68411b] dark:text-white">
    <button
      class="fa fa-bars text-[#68411b] hover:text-white dark:text-white text-3xl hover:bg-[#fd5d18] py-2 px-3 rounded mx-2 mr-5 transform transition-transform hover:scale-105 invisible"
    ...
    <div class="topbar-right gap-5">
      <div
        ...
        <div class="topbar-right gap-5">
          ...
          <button id="btnLogout"
            class="hover:text-white dark:text-white">Logout</button>
        </div>
      </div>
    </div>
  </div>
