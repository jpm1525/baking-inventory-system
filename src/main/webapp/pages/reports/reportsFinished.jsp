...
<div class="flex place-content-center flex-col ">
  ...
  <hr class="h-px my-6 bg-gray-200 border-0 dark:bg-gray-700">
              ...
              <div class="tabulator-header-contents" role="rowgroup">
                <div class="tabulator-headers" role="row" style="height: 45px;">
                  <div
                    ...
                    role="columnheader" aria-sort="none" tabulator-field="fplId"
                    style="min-width: 50px; height: 45px; width: 106px;">
                  ...
                  <div
                    ...
                    tabulator-field="dateFinished"
                    style="min-width: 100px; height: 45px; width: 163px;">
                    <div class="tabulator-col-content">
                      <div class="tabulator-col-title-holder">
                        <div class="tabulator-col-title">Date Finished</div>
                        <div class="tabulator-col-sorter">
                          <div class="tabulator-arrow"></div>
                        </div>
                      </div>
                  ...
                  <div
                    ...
                    style="min-width: 50px; height: 45px; width: 132px;">
                    <div class="tabulator-col-content">
                      <div class="tabulator-col-title-holder">
                  ...
                  <div
                    class="tabulator-col tabulator-sortable tabulator-col-sorter-element"
                    role="columnheader" aria-sort="none" tabulator-field="skuCd"
                    style="min-width: 50px; height: 45px; width: 136px;">
                    <div class="tabulator-col-content">
                      <div class="tabulator-col-title-holder">
                  ...
                  <div
                    class="tabulator-col tabulator-sortable tabulator-col-sorter-element"
                    role="columnheader" aria-sort="none" tabulator-field="branchId"
                    style="min-width: 50px; height: 45px; width: 142px;">
                    <div class="tabulator-col-content">
                      <div class="tabulator-col-title-holder">
                  ...
                  <div
                    ...
                    style="min-width: 100px; height: 45px; width: 132px;">
                    <div class="tabulator-col-content">
                      <div class="tabulator-col-title-holder">
	...
	<script type="text/javascript">
	  var reportAction = "getReportFinished";
	  var objReportTable = {};
	  var reportName = "";
	  var reportData = {};
	  var reportCols = {};
