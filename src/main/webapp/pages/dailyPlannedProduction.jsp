          ...
          <div class="tabulator-header-contents" role="rowgroup">
            <div class="tabulator-headers" role="row"
              ...
              <div
                ...
                <div class="tabulator-col-content">
                  <div class="tabulator-col-title-holder">
                    <div class="tabulator-col-title">Production
                      Date</div>
                    <div class="tabulator-col-sorter">
                      <div class="tabulator-arrow"></div>
                    </div>
...
<jsp:include page="../pages/modals/dailyPlannedProductionAddModal.jsp"></jsp:include>
<jsp:include page="../pages/modals/dailyPlannedProductionEditModal.jsp"></jsp:include>
...
<script type="text/javascript">
  ...
  var branchIdInput = JSON.parse('${branchIdInput}');
</script>
