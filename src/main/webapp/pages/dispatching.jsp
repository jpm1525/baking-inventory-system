...
<div class="flex place-content-center flex-col ">
  <div>
    <h1
      ...
      id="btnShowDispatching">Dispatching</h1>
  </div>
  ...
  <div
    ...
    <div id="divTableTabulator">
      <div
        class="relative overflow-x-auto shadow-md sm:rounded-lg basis-6/12">
        <div id="divTableTabulator" class="tabulator" role="grid"
            ...
            <div class="tabulator-header-contents" role="rowgroup">
              <div class="tabulator-headers" role="row"
                ...
                <div
                  ...
                  style="min-width: 40px; height: 45px; width: 10%;">
                ...
                <div
                  class="tabulator-col tabulator-sortable tabulator-col-sorter-element"
                  role="columnheader" aria-sort="none"
                  tabulator-field="dispatchType.dispatchTypeName"
                  style="min-width: 40px; height: 45px; width: 10%;">
                  <div class="tabulator-col-content">
                    <div class="tabulator-col-title-holder">
                ...
                <div
                  class="tabulator-col tabulator-sortable tabulator-col-sorter-element"
                  role="columnheader" aria-sort="none"
                  tabulator-field="fplId"
                  style="min-width: 40px; height: 45px; width: 10%;">
                  <div class="tabulator-col-content">
                    <div class="tabulator-col-title-holder">
                      <div class="tabulator-col-title">FPL ID</div>
                      <div class="tabulator-col-sorter">
                        <div class="tabulator-arrow"></div>
                      </div>
                    </div>
                ...
                <div
                  class="tabulator-col tabulator-sortable tabulator-col-sorter-element"
                  role="columnheader" aria-sort="none"
                  tabulator-field="fpl.sku.skuCodeName"
                  style="min-width: 40px; height: 45px; width: 10%;">
                  <div class="tabulator-col-content">
                    <div class="tabulator-col-title-holder">
                      <div class="tabulator-col-title">SKU Name</div>
                      <div class="tabulator-col-sorter">
                        <div class="tabulator-arrow"></div>
                      </div>
                    </div>
                ...
                <div
                  class="tabulator-col tabulator-sortable tabulator-col-sorter-element"
                  role="columnheader" aria-sort="none"
                  tabulator-field="branch.branchName"
                  style="min-width: 40px; height: 45px; width: 10%;">
                  <div class="tabulator-col-content">
                    <div class="tabulator-col-title-holder">
                ...
                <div
                  class="tabulator-col tabulator-sortable tabulator-col-sorter-element"
                  role="columnheader" aria-sort="none"
                  tabulator-field="destination"
                  style="min-width: 40px; height: 45px; width: 10%;">
                  <div class="tabulator-col-content">
                    <div class="tabulator-col-title-holder">
                      <div class="tabulator-col-title">Destination</div>
                      <div class="tabulator-col-sorter">
                        <div class="tabulator-arrow"></div>
                      </div>
                    </div>
                ...
                <div
                  class="tabulator-col tabulator-sortable tabulator-col-sorter-element"
                  role="columnheader" aria-sort="none"
                  tabulator-field="dispatchDate"
                  style="min-width: 40px; height: 45px; width: 10%;">
                  <div class="tabulator-col-content">
                    <div class="tabulator-col-title-holder">
                      <div class="tabulator-col-title">Dispatch
                        Date</div>
                      <div class="tabulator-col-sorter">
                        <div class="tabulator-arrow"></div>
                      </div>
          ...
          <div class="tabulator-footer">
            <div class="tabulator-footer-contents">
              <span class="tabulator-page-counter"><span><span>Showing</span><span>
                    1-1 </span><span>of</span><span> 1 </span><span>rows</span></span></span><span
                ...
                <button class="tabulator-page" type="button"
                  role="button" aria-label="First Page"
                  title="First Page" data-page="first" disabled="">First</button>
                <button class="tabulator-page" type="button"
                  role="button" aria-label="Prev Page" title="Prev Page"
                  data-page="prev" disabled="">Prev</button> <span
                ...
                <button class="tabulator-page" type="button"
                  role="button" aria-label="Last Page" title="Last Page"
...
<jsp:include page="../pages/modals/dispatchingAddModal.jsp"></jsp:include>
<jsp:include page="../pages/modals/dispatchingEditModal.jsp"></jsp:include>
