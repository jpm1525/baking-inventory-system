...
<form class="finishedProductListForm">
  <div
    ...
    <h3 class="text-3xl font-semibold text-gray-900 dark:text-white">
      Update Finished Product List</h3>
  ...
  <div class="grid gap-4 mb-4 sm:grid-cols-2 mt-5">
    <div>
      <label for="finishedProductListIdUpdate"
        class="block mb-2 text-m font-medium text-gray-900 dark:text-white">FPL
        ID</label> <input type="text" name="finishedProductListIdUpdate"
        id="finishedProductListIdUpdate"
        ...
        required="required" placeholder="Type finished product list id"
        readonly="readonly">
    </div>
    <div>
      <label for="skuCodeUpdate"
        class="block mb-2 text-m font-medium text-gray-900 dark:text-white">SKU</label>
      <select id="skuCodeUpdate" name="skuCodeUpdate"
        class="bg-gray-50 border border-gray-300 
          text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 
          dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 
          selSkuCode"
    ...
    <div>
      <label for="finishedProductListQuantityUpdate"
        class="block mb-2 text-m font-medium text-gray-900 dark:text-white">Quantity</label>
      <input type="number" name="finishedProductListQuantityUpdate"
        id="finishedProductListQuantityUpdate"
    ...
    <div>
      <label for="finishedProductListDateFinishedUpdate"
        class="block mb-2 text-m font-medium text-gray-900 dark:text-white">Date
        Finished</label> <input id="finishedProductListDateFinishedUpdate"
        type="date"
    ...
    <div>
      <label for="branchIdUpdate"
        ...
        ID</label> <input type="text" name="branchIdUpdate" id="branchIdUpdate"
        class="bg-gray-50 border border-gray-300 
          text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 
          dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 
          inputBranchId"
  ...
  <div class="flex justify-end space-x-2">
    <button id="cancelEditModalButton"
      ...
      Cancel</button>
    <button id="btnUpdateFinishedProductList" type="submit"
