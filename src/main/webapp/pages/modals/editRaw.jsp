 <script src="js/modal/modalRawEdit.js"></script>
<link rel="stylesheet" href="css/modal.css" type="text/css" />

<button id="editModalButton" class="px-4 py-2 text-white bg-indigo-500 rounded">
  Edit
</button>

<dialog id="editModal" class="relative p-6 bg-[#161624] rounded-lg shadow-lg max-w-3xl">
  <button id="closeModalTopButton" class="close-button">
    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-gray-700 hover:text-gray-900" fill="none"
      viewBox="0 0 24 24" stroke="currentColor">
      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
    </svg>
  </button>
  <label class="text-white-100 text-lg">Edit Raw Material</label>
  ...
  <div class="flex justify-end space-x-2">
    <button id="addMaterialButton" class="px-4 py-2 text-white bg-indigo-500 rounded">
      Save
    </button>
  </div>
</dialog>
