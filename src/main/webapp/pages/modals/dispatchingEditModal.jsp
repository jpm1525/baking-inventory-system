...
<form class="dispatchingForm">
  ...
  <div class="grid gap-4 mb-4 sm:grid-cols-2 mt-5">
    <div>
      <label for="dispatchingIdUpdate"
        class="block mb-2 text-m font-medium text-gray-900 dark:text-white">ID</label>
      <input type="text" name="dispatchingIdUpdate"
        id="dispatchingIdUpdate"
        ...
        required="required" placeholder="Type dispatch id"
        readonly="readonly">
    </div>
    <div>
      <label for="dispatchingTypeNameUpdate"
        class="block mb-2 text-m font-medium text-gray-900 dark:text-white">Name</label>
      <select id="dispatchingTypeNameUpdate"
        name="dispatchingTypeNameUpdate"
        class="bg-gray-50 border border-gray-300 
          text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 
          dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 
          selectDispatchingTypeName"
        required="required">
    ...
    <div>
      <label for="dispatchingFinishedProductListIdUpdate"
        class="block mb-2 text-m font-medium text-gray-900 dark:text-white">Product
        ID</label> <select type="text"
        name="dispatchingFinishedProductListIdUpdate"
        id="dispatchingFinishedProductListIdUpdate"
    ...
    <div>
      <label for="fplDateUpdate"
        class="block mb-2 text-m font-medium text-gray-900 dark:text-white">Product
        Batch Date</label> <input id="fplDateUpdate" type="date"
    ...
    <div>
      <label for="fplQuantityUpdate"
        class="block mb-2 text-m font-medium text-gray-900 dark:text-white">Stock</label>
      <input type="number" name="fplQuantityUpdate"
        id="fplQuantityUpdate"
        class="num-input bg-gray-50 border border-gray-300 
          text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 
          dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500
          [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
        required="required" max="0" min="0" readonly="readonly"
        value="0">
    </div>
    <div>
      <label for="fplResultingStockUpdate"
        class="block mb-2 text-m font-medium text-gray-900 dark:text-white">Resulting
        Stock</label> <input type="number" name="fplResultingStockUpdate"
        id="fplResultingStockUpdate"
        class="num-input bg-gray-50 border border-gray-300 
          text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 
          dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500
          [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
    ...
    <div>
      <label for="dispatchingQuantityUpdate"
        class="block mb-2 text-m font-medium text-gray-900 dark:text-white">Quantity</label>
      <input type="number" name="dispatchingQuantityUpdate"
        id="dispatchingQuantityUpdate"
        class="num-input bg-gray-50 border border-gray-300 
          text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 
          dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500
          [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
        required="required" placeholder="Type quantity" max="0" min="0"
        value="0">
    </div>
    <div>
      <label for="dispatchingBranchUpdate"
        class="block mb-2 text-m font-medium text-gray-900 dark:text-white">Branch</label>
      <input type="text" id="dispatchingBranchUpdate"
        name="dispatchingBranchUpdate"
        class="bg-gray-50 border border-gray-300 
          text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 
          dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 
          "
    ...
    <div>
      <label for="dispatchingDestinationUpdate"
        class="block mb-2 text-m font-medium text-gray-900 dark:text-white">Destination</label>
      <input type="text" name="dispatchingDestinationUpdate"
        id="dispatchingDestinationUpdate"
        class="bg-gray-50 border border-gray-300 
          text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 
          dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
    ...
    <div>
      <label for="dispatchingDateUpdate"
        class="block mb-2 text-m font-medium text-gray-900 dark:text-white">Dispatch
        Date</label> <input id="dispatchingDateUpdate" type="date"
        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm 
          rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 
          dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
  ...
  <div class="flex justify-end space-x-2">
    <button id="cancelEditModalButton"
      ...
      Cancel</button>
    <button id="btnUpdateDispatching" type="submit"
