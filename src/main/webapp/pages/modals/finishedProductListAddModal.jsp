  ...
  <form class="finishedProductListForm">
    ...
    <div class="grid gap-4 mb-4 sm:grid-cols-2 mt-5">
       <div class = "col-span-2">
        <label for="skuCodeCreate" class="block mb-2 text-m font-medium text-gray-900 dark:text-white">SKU</label>
        <select id="skuCodeCreate" name="skuCodeCreate" class="bg-gray-50 border border-gray-300 
      ...
      <div>
        <label for="finishedProductListQuantityCreate" class="block mb-2 text-m font-medium text-gray-900 dark:text-white">Quantity</label>
        <input type="number" name="finishedProductListQuantityCreate" id="finishedProductListQuantityCreate" class="num-input bg-gray-50 border border-gray-300 
          text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 
          dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" 
          required="required" placeholder="Type quantity" min="0" max="9223372036854775807">
      </div>
      <div>
        <label for="finishedProductListDateFinishedCreate" class="block mb-2 text-m font-medium text-gray-900 dark:text-white">Date Finished</label>
          <input id="finishedProductListDateFinishedCreate" type="date" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm 
    ...
    <div class="flex justify-end space-x-2">
      ...
      <button id="btnCreateFinishedProductList" type="submit" class="text-white inline-flex items-center bg-blue-700 
