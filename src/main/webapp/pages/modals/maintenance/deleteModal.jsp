...
<dialog id="deleteModal"
  class="relative p-6 bg-white dark:bg-gray-700 rounded-lg shadow-lg max-w-xl">
...
<div class="p-4 md:p-5 text-center">
  ...
  <button id="deleteSaveModalButton"
    ...
    Delete</button>
  <button id="cancelDeleteModalButton"
...
<div class="flex justify-middle space-x-2"></div>
