...
<dialog id="deleteModal" class="relative p-6 bg-white dark:bg-gray-700 rounded-lg shadow-lg max-w-xl">
  ...
  <div class="p-4 md:p-5 text-center">
    ...
    <div class="mb-2">
      <label for="passwordDelete" class="block mb-2 text-m font-medium text-gray-900 dark:text-white">Password</label>
      <input type="password" name="passwordDelete" id="passwordDelete" class="bg-gray-50 border border-gray-300 
