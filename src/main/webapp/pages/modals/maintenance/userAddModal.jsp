...
<form class="userForm">
  ...
  <div class="grid gap-4 mb-4 sm:grid-cols-1 mt-5">
    <div>
      <label for="usernameCreate"
        class="block mb-2 text-m font-medium text-gray-900 dark:text-white">Username</label>
      <input type="text" name="usernameCreate" id="usernameCreate"
        ...
        required="required" placeholder="Type username" maxlength="10"
        minlength="1">
    </div>
    <div>
      <label for="passwordCreate"
        class="block mb-2 text-m font-medium text-gray-900 dark:text-white">Password</label>
      <input type="text" name="passwordCreate" id="passwordCreate"
        class="bg-gray-50 border border-gray-300 
          text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 
          dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
    ...
    <div>
      <label for="branchIdCreate"
        ...
        <input type="text" name="branchIdCreate" id="branchIdCreate"
        class="bg-gray-50 border border-gray-300 
          text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 
          dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
        required="required" placeholder="Type branch id" maxlength="10"
        minlength="1">
    </div>
  </div>
  ...
  <div class="flex justify-end space-x-2">
    <button id="cancelAddModalButton"
      ...
      Cancel</button>
    <button id="btnCreateUserMain" type="submit"
