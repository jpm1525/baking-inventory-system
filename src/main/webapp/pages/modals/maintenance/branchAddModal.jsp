...
<dialog id="addModal" class="relative p-6 bg-white dark:bg-gray-700 rounded-lg shadow-lg max-w-2xl">
  <form class="branchForm">
    ...
    <div class="grid gap-4 mb-4 sm:grid-cols-1 mt-5">
      <div>
        <label for="branchIdCreate" class="block mb-2 text-m font-medium text-gray-900 dark:text-white">ID</label>
      ...
      <div>
        <label for="branchNameCreate" class="block mb-2 text-m font-medium text-gray-900 dark:text-white">Name</label>
        <input type="text" name="branchNameCreate" id="branchNameCreate" class="bg-gray-50 border border-gray-300 
          text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 
          dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" 
    ...
    <div class="flex justify-end space-x-2">
      ...
      <button id="btnCreateBranch" type="submit" class="text-white inline-flex items-center bg-blue-700 
