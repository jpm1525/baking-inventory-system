...
<form class="materialCodeForm">
  ...
  <div class="grid gap-4 mb-4 sm:grid-cols-1 mt-5">
    <div>
      ...
      <input type="text" name="materialCodeUpdate"
        id="materialCodeUpdate"
  ...
  <div class="flex justify-end space-x-2">
    <button id="cancelEditModalButton"
      ...
      Cancel</button>
    <button id="btnUpdateMaterialCode" type="submit"
