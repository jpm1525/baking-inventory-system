...
<dialog id="editModal" class="relative p-6 bg-white dark:bg-gray-700 rounded-lg shadow-lg max-w-2xl">
  <form class="branchForm"> 
    ...
    <div class="grid gap-4 mb-4 sm:grid-cols-1 mt-5">
      <div>
        <label for="branchIdUpdate" class="block mb-2 text-m font-medium text-gray-900 dark:text-white">ID</label>
    ...
    <div class="flex justify-end space-x-2">
      ...
      <button id="btnUpdateBranch" type="submit" class="text-white inline-flex items-center bg-blue-700 
