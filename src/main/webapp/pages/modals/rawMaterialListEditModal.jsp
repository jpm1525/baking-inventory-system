...
<form class="rawMaterialListForm">
  ...
  <div class="grid gap-4 mb-4 sm:grid-cols-2 mt-5">
    <div>
      <label for="rawMaterialListIdUpdate"
        class="block mb-2 text-m font-medium text-gray-900 dark:text-white">Material
        ID</label> <input type="text" name="rawMaterialListIdUpdate"
        id="rawMaterialListIdUpdate"
    ...
    <div>
      <label for="rawMaterialListQuantityUpdate"
        class="block mb-2 text-m font-medium text-gray-900 dark:text-white">Quantity</label>
      <input type="number" name="rawMaterialListQuantityUpdate"
        id="rawMaterialListQuantityUpdate"
    ...
    <div>
      <label for="rawMaterialListDateReceiveUpdate"
        class="block mb-2 text-m font-medium text-gray-900 dark:text-white">Date
        Received</label> <input id="rawMaterialListDateReceiveUpdate"
        type="date"
    ...
    <div>
      <label for="userIdUpdate"
        ...
        ID</label> <input type="text" name="userIdUpdate" id="userIdUpdate"
        class="bg-gray-50 border border-gray-300 
          text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 
          dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
  ...
  <div class="flex justify-end space-x-2">
    <button id="cancelEditModalButton"
      ...
      Cancel</button>
    <button id="btnUpdateRawMaterialList" type="submit"
