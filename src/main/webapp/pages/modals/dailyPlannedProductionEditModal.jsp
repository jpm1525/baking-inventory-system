...
<form class="dailyPlannedProductionForm">
  <div
    ...
    <h3 class="text-3xl font-semibold text-gray-900 dark:text-white">
      Edit Daily Planned Production</h3>
  ...
  <div class="grid gap-4 mb-4 sm:grid-cols-2 mt-5">
    <div>
      <label for="dailyPlannedProductionIdUpdate"
        class="block mb-2 text-m font-medium text-gray-900 dark:text-white">ID</label>
      <input type="text" name="dailyPlannedProductionIdUpdate"
        id="dailyPlannedProductionIdUpdate"
    ...
    <div>
      <label for="dailyPlannedProductionDateUpdate"
        class="block mb-2 text-m font-medium text-gray-900 dark:text-white">Production
        Date</label> <input id="dailyPlannedProductionDateUpdate" type="date"
    ...
    <div>
      <label for="dailyPlannedProductionBranchId"
        class="block mb-2 text-m font-medium text-gray-900 dark:text-white">Branch
        ID - Name</label> <input id="dailyPlannedProductionBranchId"
        dataBranchId="" name="dailyPlannedProductionBranchId"
        class="bg-gray-50 border border-gray-300 
          text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 
          dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 
    ...
    <div>
      <label for="dailyPlannedProductionSkuCdUpdate"
        class="block mb-2 text-m font-medium text-gray-900 dark:text-white">SKU</label>
      <select id="dailyPlannedProductionSkuCdUpdate"
        name="dailyPlannedProductionSkuCdUpdate"
        class="bg-gray-50 border border-gray-300 
          text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 
          dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 
    ...
    <div>
      <label for="dailyPlannedProductionQuantityUpdate"
        class="block mb-2 text-m font-medium text-gray-900 dark:text-white">Quantity</label>
      <input type="number" name="dailyPlannedProductionQuantityUpdate"
        id="dailyPlannedProductionQuantityUpdate"
  ...
  <div class="flex justify-end space-x-2">
    <button id="cancelEditModalButton"
      ...
      Cancel</button>
    <button id="btnUpdateDailyPlannedProduction" type="submit"
