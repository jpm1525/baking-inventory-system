...
<form class="rawMaterialListForm">
  ...
  <div class="grid gap-4 mb-4 sm:grid-cols-2 mt-5">
    ...
    <div>
      <label for="rawMaterialListQuantityCreate"
        class="block mb-2 text-m font-medium text-gray-900 dark:text-white">Quantity</label>
      <input type="number" name="rawMaterialListQuantityCreate"
        id="rawMaterialListQuantityCreate"
        class="num-input bg-gray-50 border border-gray-300 
          text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 
          dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
        required="required" placeholder="Enter quantity" maxlength="50"
        minlength="1">
    </div>
    <div>
      <label for="rawMaterialListDateReceiveCreate"
        class="block mb-2 text-m font-medium text-gray-900 dark:text-white">Date
        Received</label> <input id="rawMaterialListDateReceiveCreate"
        type="date"
    ...
    <div>
      <label for="userIdCreate"
        class="block mb-2 text-m font-medium text-gray-900 dark:text-white">User
        ID</label> <input type="text" name="userIdCreate" id="userIdCreate"
        class="bg-gray-50 border border-gray-300 
          text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 
          dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 
          rawUserId"
    ...
    <div>
      <label for="branchIdCreate"
        class="block mb-2 text-m font-medium text-gray-900 dark:text-white">Branch</label>
      <input id="branchIdCreate" name="branchIdCreate" dataBranchId=""
        type="text"
        class="bg-gray-50 border border-gray-300 
              text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 
              dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 
  ...
  <div class="flex justify-end space-x-2">
    <button id="cancelAddModalButton"
      ...
      Cancel</button>
    <button id="btnCreateRawMaterialList" type="submit"
