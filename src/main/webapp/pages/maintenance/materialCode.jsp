...
<link rel="stylesheet" href="css/tabulator_simple.min.css"vtype="text/css">
...
<div class="flex place-content-center flex-col ">
  <div>
    <h1
      ...
      id="btnMaterialCode">Material Code</h1>
  </div>
          ...
          <div class="tabulator-header-contents" role="rowgroup">
            <div class="tabulator-headers" role="row"
              ...
              <div
                ...
                <div class="tabulator-col-content">
                  <div class="tabulator-col-title-holder">
                    <div class="tabulator-col-title">Unit of
                      Measurement</div>
                    <div class="tabulator-col-sorter">
                      <div class="tabulator-arrow"></div>
                    </div>
...
<jsp:include page="../modals/maintenance/materialCodeAddModal.jsp"></jsp:include>
<jsp:include page="../modals/maintenance/materialCodeEditModal.jsp"></jsp:include>
