...
public class ProductionMaterialController extends HttpServlet {
	...
	private ProductionMaterialServiceImpl productionMaterialService = (ProductionMaterialServiceImpl) context
			.getBean("productionMaterialService");
	private MaterialCodeServiceImpl materialCodeService = (MaterialCodeServiceImpl) context
			.getBean("materialCodeService");
	private RawMaterialListServiceImpl rawMaterialListService = (RawMaterialListServiceImpl) context
			.getBean("rawMaterialListService");
